...
INSERT INTO job_listings (
    ...
    stack_summary, description, created_at
         ...
         Required Skills:
         - Strong background with AWS services.
         ...
         Why CloudForge?
         We are a team of cloud purists — everything we build is automated, reproducible, and scalable. You will join a culture where engineering quality matters and where you can directly influence architecture decisions.',
             NOW()
         )
    ON CONFLICT DO NOTHING;
